...
console.log(`Circumcircle radius: ${triangle1.circumsCircleRadius().toFixed(4)} mm`)
console.log("\n")
...
console.log(`Circumcircle radius: ${triangle2.circumsCircleRadius().toFixed(4)} mm`)
console.log("\n")
...
console.log(`Circumcircle radius: ${triangle3.circumsCircleRadius().toFixed(4)} mm`)
console.log("\n")
...
console.log(`Circumcircle radius: ${triangle4.circumsCircleRadius().toFixed(4)} mm`)
console.log("\n")
...
console.log(`Circumcircle radius: ${triangle5.circumsCircleRadius().toFixed(4)} mm`)
