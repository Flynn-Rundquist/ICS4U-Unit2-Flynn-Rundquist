...
console.log(`Inner circle circumference: ${triangle1.innerCircleCircumference().toFixed(4)} mm`)
console.log("\n")
...
console.log(`Inner circle circumference: ${triangle2.innerCircleCircumference().toFixed(4)} mm`)
console.log("\n")
...
console.log(`Inner circle circumference: ${triangle3.innerCircleCircumference().toFixed(4)} mm`)
